...
require('lazy').setup({
  ...
  { 'nvim-pack/nvim-spectre', dependencies = { 'nvim-lua/plenary.nvim', 'folke/trouble.nvim' } },
  ...
  },
  {
    ...
    config = function()
      ...
      -- Highlighting is now enabled through Neovim itself.
      vim.api.nvim_create_autocmd('FileType', {
        ...
        callback = function(args)
          ...
          if vim.tbl_contains(parsers, language) then
            pcall(vim.treesitter.start, args.buf, language)
          end
        end,
      })

      -- Tree-sitter indentation remains experimental. Enable it only for
      -- filetypes where it is generally useful.
